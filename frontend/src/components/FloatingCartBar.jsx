  ...
  return (
    <AnimatePresence>
      {totalCount > 0 && (
        ...
        >
          <div className="bg-cyan-600 text-white rounded-2xl shadow-2xl p-3 sm:p-3.5 border border-cyan-500/30 flex items-center justify-between gap-3 backdrop-blur-md">
            ...
            <div className="flex items-center gap-3">
              <div className="relative w-10 h-10 rounded-xl bg-white/15 flex items-center justify-center font-bold text-white shrink-0">
                ...
                <span className="absolute -top-1.5 -right-1.5 w-5 h-5 bg-amber-400 text-cyan-950 font-black text-[11px] rounded-full flex items-center justify-center shadow-xs">
                  {totalCount}
                </span>
              </div>
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs text-cyan-200 line-through">
            ...
            <Link
              to="/cart"
              className="group flex items-center gap-2 bg-amber-400 hover:bg-amber-300 text-cyan-950 px-4 py-2.5 rounded-xl font-bold text-xs sm:text-sm tracking-wide transition-all shadow-md active:scale-95 shrink-0"
            >
              <span>View Cart</span>
